...
/**
 * ProductDetail コンポーネント（本番実装）
 * 商品詳細表示 — 在庫数表示・在庫切れ時ボタン無効化対応
 */
    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-6">
            <h2 className="text-sm font-medium text-base-900/60">在庫数</h2>
            {isOutOfStock ? (
              <p className="mt-1 font-medium text-red-600">在庫切れ</p>
            ) : (
              <p className="mt-1 text-base-900/80">{product.stock}点</p>
            )}
          </div>
