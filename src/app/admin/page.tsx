...
export default function AdminDashboard() {
  ...
  const cards = [
    { label: '商品数', value: stats.productCount, href: '/admin/products' },
    { label: '注文数', value: stats.orderCount, href: '/admin/orders' },
    { label: '処理待ち', value: stats.pendingOrders, href: '/admin/orders?status=pending' },
  ];
